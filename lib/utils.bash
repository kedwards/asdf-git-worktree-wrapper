...
# NOTE: You might want to remove this if git-worktree-wrapper is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if git-worktree-wrapper has other means of determining installable versions.
	list_github_tags
}
...
download_release() {
	...
	# TODO: Adapt the release URL convention for git-worktree-wrapper
